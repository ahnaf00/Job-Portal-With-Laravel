...
@section('frontend-content')
    ...
    <script>
        ...
        form.addEventListener('submit',async (e) => {
            ...
            emailError.textContent = 'Please enter a vcalid email address';
            passwordError.textContent = 'Please enter your password';
            ...
            try
            {
                ...
                // Prefer field-level errors from server
                const errs = data.errors || {};
                if (errs.email && errs.email.length) {
                    emailInput.classList.add('is-invalid');
                    emailError.textContent = errs.email[0];
                }
                if (errs.password && errs.password.length) {
                    passwordInput.classList.add('is-invalid');
                    passwordError.textContent = errs.password[0];
                }
